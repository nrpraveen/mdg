...
class Optimize {
	...
	public function __construct() {
		...
		// Initialize
		if (!file_exists(get_template_directory().'/css')) mkdir(get_template_directory().'/css');
		if (!file_exists(get_template_directory().'/js')) mkdir(get_template_directory().'/js');
		$this->css = apply_filters('mdg_optimize_css_prefix', get_template_directory().'/css/cache.');
		$this->js = apply_filters('mdg_optimize_js_prefix', get_template_directory().'/js/cache.');
		...
		spl_autoload_register(function($class_name) {
			if (strstr($class_name, 'MatthiasMullie\\')) {
				$file = get_template_directory().'/lib/'.str_replace(['MatthiasMullie\\', '\\'], ['', '/'], $class_name).'.php';
	...
	private function minify_js() {
		require_once get_template_directory().'/lib/Minify/Minify.php';
		require_once get_template_directory().'/lib/Minify/JS.php';
	...
	private function minify_css() {
		require_once get_template_directory().'/lib/Minify/Minify.php';
		require_once get_template_directory().'/lib/Minify/CSS.php';
		require_once get_template_directory().'/lib/Minify/ConverterInterface.php';
		require_once get_template_directory().'/lib/Minify/Converter.php';
		require_once get_template_directory().'/lib/Minify/Exception.php';
	...
	private function enqueue_js() {
		...
		$js_uri = str_replace(get_template_directory(), get_template_directory_uri(), $js_file);
		if ($this->inline) {
			echo "\n<script>\n";
	...
	private function enqueue_css() {
		...
		$css_uri = str_replace(get_template_directory(), get_template_directory_uri(), $css_file);
		if ($this->inline) {
			echo "\n<style>\n";
